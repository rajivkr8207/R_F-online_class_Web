    ...
    const [NewResourse, setNewResource] = useState([
        {
          ...
          description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta quibusdam",
              ...
              return (
                <div className="w-[23rem] bg-white flex flex-col mx-auto my-3 pb-5">
                  ...
                  <span className="text-[#fe7d55] text-sm font-semibold flex gap-3 capitalize">
                    ...
                    <NavLink className="flex my-auto gap-3 font-semibold text-[#333333]">Readmore <FaLongArrowAltRight className='my-auto' /></NavLink>
                  </div>
                </div>
              );
            })}
...
<div className="lg:w-[50%] my-auto  mx-auto pl-5">
    ...
    <div className="flex gap-4 my-5">
      <img className='w-[3rem] h-[3rem] rounded-full my-auto' src={team2} alt="" srcset="" />
      <div className='flex flex-col text-[#333333] my-auto text-sm font-bold leading-5'>
        <span>Bessie Cooper</span>two month ago </div>
    </div>
  </div>
  ...
  <div className="relative lg:w-[50%] my-3 ">
    <img
      ...
      srcset=""
    />
    <div className="absolute bottom-[-2rem]  left-[-1rem] flex flex-col gap-3 man_hidden_css w-[7rem] h-[7rem] rounded-3xl bg-[#fe7d55] ">
