...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="my-3">
        <div><h4 className="text-center font-bold text-[#333333]">Trusted by leading serval unicorn companies</h4></div>
        <div className="flex justify-evenly flex-wrap">
          {
            companies.map((item)=>{
              return(
                <span className="text-2xl font-bold text-[#333333]">{item.name}</span>
              )
            })
          }
        </div>
