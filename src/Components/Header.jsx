...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="text-2xl font-bold">ECO<span className="text-[#fe7d55]">LABS</span></div>
        ...
        <div className={`flex lg:flex-row flex-col mt-4 my-auto gap-5 mr-10 mobile_absolute transition-all duration-300 ease-in bg-white pb-5   ${Oppen ? 'top-8 md:opacity-100': 'top-[-490px] md:opacity-100'}`}>
